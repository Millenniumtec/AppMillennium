...
var maleCharacterImage = 'lelekopixel.png';
var femaleCharacterImage = 'lelekapixel.png';
...
window.onload = function () {
    document.getElementById('male-character').addEventListener('click', () => {
        startGameWithCharacter('lelekopixel.png', 'lelekopixel.png', 'leleko-left.png');
    });

    document.getElementById('female-character').addEventListener('click', () => {
        startGameWithCharacter('lelekapixel.png', 'lelekapixel.png', 'leleka-left.png');
    });
...
function update() {
    ...
    if (gameOver) {
        context.fillText("Pressione 'Espaço' para jogar de novo", boardWidth/7, boardHeight*7/8);
    }
}
